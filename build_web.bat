...
set EMSCRIPTEN_SDK_DIR=C:\Users\johnb\repos\emsdk
...
odin build  src\main_web -target:js_wasm32 -build-mode:obj -o:speed -define:RAYLIB_WASM_LIB=env.o -define:RAYGUI_WASM_LIB=env.o -out:%OUT_DIR%\game
...
set flags=-sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS --shell-file src\main_web\index_template.html --preload-file assets
